...
namespace polyhedralGravity {
    ...
    void TetgenAdapter::readNode(const std::string &filename) {
        SPDLOG_LOGGER_DEBUG(PolyhedraleGravityLogger::DEFAULT_LOGGER.getLogger() , "Reading the file {}.node", filename);
    ...
    void TetgenAdapter::readFace(const std::string &filename) {
        SPDLOG_LOGGER_DEBUG(PolyhedraleGravityLogger::DEFAULT_LOGGER.getLogger() , "Reading the file {}.face", filename);
    ...
    void TetgenAdapter::readOff(const std::string &filename) {
        SPDLOG_LOGGER_DEBUG(PolyhedraleGravityLogger::DEFAULT_LOGGER.getLogger() , "Reading the file {}.off", filename);
    ...
    void TetgenAdapter::readPly(const std::string &filename) {
        SPDLOG_LOGGER_DEBUG(PolyhedraleGravityLogger::DEFAULT_LOGGER.getLogger() , "Reading the file {}.ply", filename);
        this->checkIntegrity(filename, 'a');
        try {
    ...
    void TetgenAdapter::readStl(const std::string &filename) {
        SPDLOG_LOGGER_DEBUG(PolyhedraleGravityLogger::DEFAULT_LOGGER.getLogger() , "Reading the file {}.stl", filename);
        this->checkIntegrity(filename, 'a');
        try {
    ...
    void TetgenAdapter::readMesh(const std::string &filename) {
        SPDLOG_LOGGER_DEBUG(PolyhedraleGravityLogger::DEFAULT_LOGGER.getLogger() , "Reading the file {}.mesh");
        this->checkIntegrity(filename, 'a');
        try {
