...
int main(int argc, char *argv[]) {
    ...
    if (argc != 2) {
        SPDLOG_LOGGER_INFO(PolyhedraleGravityLogger::DEFAULT_LOGGER.getLogger(), "Wrong program call! "
    ...
    try {
        ...
        SPDLOG_LOGGER_INFO(PolyhedraleGravityLogger::DEFAULT_LOGGER.getLogger(), "The calculation started...");
        ...
        SPDLOG_LOGGER_INFO(PolyhedraleGravityLogger::DEFAULT_LOGGER.getLogger(),
        ...
        SPDLOG_LOGGER_ERROR(PolyhedraleGravityLogger::DEFAULT_LOGGER.getLogger(), "{}", e.what());
        return -1;
    }
}